...
const CADASTROS_TELAS = [
  ...
  { col: 'tela_produto_auxiliares', jwt: 'gtela_produto_auxiliares', page: '/pages/grupos-produto.html', label: 'Grupo / Subfamília / Unidade / Tipo Grade',
    crud: [
      { col: 'incluir_produto_auxiliares', jwt: 'incluir_produto_auxiliares' },
      { col: 'alterar_produto_auxiliares', jwt: 'alterar_produto_auxiliares' },
      { col: 'excluir_produto_auxiliares', jwt: 'excluir_produto_auxiliares' },
    ] },
  ...
  { col: 'tela_plano_contas', jwt: 'gtela_plano_contas', page: '/pages/plano-contas.html', label: 'Plano de Contas',
    crud: [{ col: 'incluir_plano_contas', jwt: 'incluir_plano_contas' }, { col: 'alterar_plano_contas', jwt: 'alterar_plano_contas' }, { col: 'excluir_plano_contas', jwt: 'excluir_plano_contas' }] },
  ...
  { col: 'tela_tipo_cliente', jwt: 'gtela_tipo_cliente', page: '/pages/tipo-cliente.html', label: 'Tipo de Cliente',
    crud: [{ col: 'incluir_tipo_cliente', jwt: 'incluir_tipo_cliente' }, { col: 'alterar_tipo_cliente', jwt: 'alterar_tipo_cliente' }, { col: 'excluir_tipo_cliente', jwt: 'excluir_tipo_cliente' }] },
...
const COMERCIAL_TELAS = [
  ...
  { col: 'tela_relatorios_regiao', jwt: 'gtela_relatorios_regiao', page: '/pages/comercial-relatorios-regiao.html', label: 'Relatórios Região / Carteira' },
  ...
  { col: 'tela_recompra', jwt: 'gtela_recompra', page: '/pages/comercial-recompra.html', label: 'Carteira de Recompra' },
