...
(function () {
  const PAGE_GTELA = {
    ...
    '/pages/grupos-produto.html': { key: 'gtela_produto_auxiliares', label: 'Grupo de Produto' },
    '/pages/subfamilias-produto.html': { key: 'gtela_produto_auxiliares', label: 'Subfamília de Produto' },
    '/pages/unidades-produto.html': { key: 'gtela_produto_auxiliares', label: 'Unidade de Produto' },
    '/pages/tipos-grade-produto.html': { key: 'gtela_produto_auxiliares', label: 'Tipo de Grade' },
    '/pages/produto-auxiliares.html': { key: 'gtela_produto_auxiliares', label: 'Cadastros do Produto' },
    '/pages/locais-armazenamento.html': { key: 'incluir_locais_armazenamento', label: 'Locais de Armazenamento' },
    ...
    '/pages/consulta-precos.html': { key: 'gtela_tabela_precos', label: 'Consulta Rápida de Preços' },
    ...
    '/pages/plano-contas.html': { key: 'gtela_plano_contas', label: 'Plano de Contas' },
    '/pages/centro-custo.html': { key: 'gtela_centro_custo', label: 'Centro de Custo' },
    '/pages/cartoes-corporativos.html': { key: 'gtela_cartoes', label: 'Cartões Corporativos' },
    '/pages/cheques.html': { key: 'gtela_cheques', label: 'Cheques de Terceiros' },
    '/pages/previsao-caixa.html': { key: 'gtela_previsao_caixa', label: 'Previsão de Caixa' },
    '/pages/emails-enviados.html': { key: 'gtela_emails_enviados', label: 'E-mails Enviados' },
    '/pages/segmentos.html': { key: 'gtela_segmentos', label: 'Segmento de Cliente' },
    '/pages/categorias.html': { key: 'gtela_segmentos', label: 'Categoria de Produto' },
    '/pages/tipo-cliente.html': { key: 'gtela_tipo_cliente', label: 'Tipo de Cliente' },
    '/pages/regiao-rota.html': { key: 'gtela_regiao_rota', label: 'Regiões e Rotas' },
    '/pages/regioes.html': { key: 'gtela_regiao_rota', label: 'Regiões' },
  ...
  const PAGE_CRUD = {
    ...
    '/pages/grupos-produto.html': { incluir: 'incluir_produto_auxiliares', alterar: 'alterar_produto_auxiliares', excluir: 'excluir_produto_auxiliares' },
    '/pages/subfamilias-produto.html': { incluir: 'incluir_produto_auxiliares', alterar: 'alterar_produto_auxiliares', excluir: 'excluir_produto_auxiliares' },
    '/pages/unidades-produto.html': { incluir: 'incluir_produto_auxiliares', alterar: 'alterar_produto_auxiliares', excluir: 'excluir_produto_auxiliares' },
    '/pages/tipos-grade-produto.html': { incluir: 'incluir_produto_auxiliares', alterar: 'alterar_produto_auxiliares', excluir: 'excluir_produto_auxiliares' },
    '/pages/locais-armazenamento.html': { incluir: 'incluir_locais_armazenamento', alterar: 'alterar_locais_armazenamento', excluir: 'excluir_locais_armazenamento' },
    ...
    '/pages/plano-contas.html': { incluir: 'incluir_plano_contas', alterar: 'alterar_plano_contas', excluir: 'excluir_plano_contas' },
    '/pages/centro-custo.html': { incluir: 'incluir_centro_custo', alterar: 'alterar_centro_custo', excluir: 'excluir_centro_custo' },
    '/pages/cartoes-corporativos.html': { incluir: 'incluir_cartoes', alterar: 'alterar_cartoes', excluir: 'excluir_cartoes' },
    '/pages/cheques.html': { incluir: 'incluir_cheques', alterar: 'alterar_cheques', excluir: 'excluir_cheques' },
    '/pages/segmentos.html': { incluir: 'incluir_segmentos', alterar: 'alterar_segmentos', excluir: 'excluir_segmentos' },
    '/pages/categorias.html': { incluir: 'incluir_segmentos', alterar: 'alterar_segmentos', excluir: 'excluir_segmentos' },
    '/pages/tipo-cliente.html': { incluir: 'incluir_tipo_cliente', alterar: 'alterar_tipo_cliente', excluir: 'excluir_tipo_cliente' },
    '/pages/regiao-rota.html': { incluir: 'incluir_regioes', alterar: 'alterar_regioes', excluir: 'excluir_regioes' },
    '/pages/regioes.html': { incluir: 'incluir_regioes', alterar: 'alterar_regioes', excluir: 'excluir_regioes' },
