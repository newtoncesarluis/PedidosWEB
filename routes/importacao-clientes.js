...
const DEFAULT_CAMPOS = [
  ...
  { nome_campo: 'data_situacaocnpj',     apelido: 'Data Situação CNPJ',          tipo: 'data',    ordem: 65, obrigatorio: 'N' },
  { nome_campo: 'atividadeprincipal',    apelido: 'Atividade Principal',         tipo: 'texto',   ordem: 66, obrigatorio: 'N' },
  { nome_campo: 'atividadesecundaria',   apelido: 'Atividade Secundária',        tipo: 'texto',   ordem: 67, obrigatorio: 'N' },
  { nome_campo: 'quadrosocios',          apelido: 'Quadro de Sócios',            tipo: 'texto',   ordem: 68, obrigatorio: 'N' },
  { nome_campo: 'numsocios',             apelido: 'Nº de Sócios',                tipo: 'texto',   ordem: 69, obrigatorio: 'N' },
  { nome_campo: 'numalteracoes',         apelido: 'Nº de Alterações',            tipo: 'texto',   ordem: 70, obrigatorio: 'N' },
  { nome_campo: 'imprimirsuframaped',    apelido: 'Imprimir Suframa no Ped. (S/N)', tipo: 'texto', ordem: 71, obrigatorio: 'N' },
  { nome_campo: 'descontoIPIsuframaped', apelido: 'Desc. IPI Suframa (S/N)',     tipo: 'texto',   ordem: 72, obrigatorio: 'N' },
  { nome_campo: 'numerosulframa',        apelido: 'Nº Suframa',                  tipo: 'texto',   ordem: 73, obrigatorio: 'N' },
  { nome_campo: 'ufpadraocadastros',     apelido: 'UF Padrão Cadastros',         tipo: 'texto',   ordem: 74, obrigatorio: 'N' },
  { nome_campo: 'rj_comercial',          apelido: 'Referência Comercial',        tipo: 'texto',   ordem: 75, obrigatorio: 'N' },
  // ── Relacionamento entre clientes ────────────────────────────────────────────
  { nome_campo: 'clienteprincipal',      apelido: 'É Cliente Principal (S/N)',    tipo: 'texto',   ordem: 76, obrigatorio: 'N' },
  { nome_campo: 'cod_clienteprincipal',  apelido: 'Cód. Cliente Principal',      tipo: 'texto',   ordem: 77, obrigatorio: 'N' },
  { nome_campo: 'nomeclienteprincipal',  apelido: 'Nome Cliente Principal',      tipo: 'texto',   ordem: 78, obrigatorio: 'N' },
  // ── Observações / Geral ──────────────────────────────────────────────────────
  { nome_campo: 'observacoes',           apelido: 'Observações Gerais',          tipo: 'texto',   ordem: 79, obrigatorio: 'N' },
  { nome_campo: 'venda_suspensa',        apelido: 'Venda Suspensa (S/N)',        tipo: 'texto',   ordem: 80, obrigatorio: 'N' },
  { nome_campo: 'status',                apelido: 'Status (A/I)',                tipo: 'texto',   ordem: 81, obrigatorio: 'N' },
  { nome_campo: 'latitude',              apelido: 'Latitude',                    tipo: 'texto',   ordem: 82, obrigatorio: 'N' },
  { nome_campo: 'longitude',             apelido: 'Longitude',                   tipo: 'texto',   ordem: 83, obrigatorio: 'N' },
];
